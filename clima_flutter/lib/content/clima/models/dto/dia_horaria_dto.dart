...
import 'package:ClimaFlutter/content/clima/models/dto/dia_dto.dart';
...
class DiaHorariaDto extends DiaDto {
  ...
  static DiaDto fromJson(Map<String, dynamic> json) {
    return DiaHorariaDto(
      ...
      puestaSol: MyLocalizations.parseTime(json['ocaso']),
    );
  }
    ...
    return WeatherLong(
      ...
      vientoHora: _fill24Hours({
        for (var e in vientoAndRachaMax
          ...
          e.periodo: e.velocidad.sum ~/ e.velocidad.length
      }),
